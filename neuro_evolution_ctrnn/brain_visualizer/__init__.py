...
class BrainVisualizerHandler(object):
    ...
    def launch_new_visualization(self, brain, width=1800, height=800, displayColor=(0, 0, 0),
...
class PygameBrainVisualizer(object):
    def __init__(self, brain, width, height, displayColor, neuronRadius, colorClippingRange):
        self.brain = brain
        ...
        # os.environ['SDL_VIDEO_WINDOW_POS'] = "%d,%d" % (115, 510)  # for a fixed position of the window
