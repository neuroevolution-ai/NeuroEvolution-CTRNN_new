...
def lnn_config() -> LayeredNNCfg:
    return LayeredNNCfg(type="LNN", normalize_input=False, normalize_input_target=2, number_neurons_layer1=2,
...
def lstm_config() -> LSTMCfg:
    return LSTMCfg(type="LSTM_PyTorch", normalize_input=False, normalize_input_target=2, lstm_num_layers=3,
                   use_biases=True)
